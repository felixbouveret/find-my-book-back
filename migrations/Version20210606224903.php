 ...
 */
final class Version20210606224903 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livres CHANGE category categorie_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livres CHANGE categorie_id category INT NOT NULL');
    }
}
